...
server_scripts { '@oxmysql/lib/MySQL.lua', 'server/main.lua', 'server/fn.lua', 'server/modules/*.lua' }
client_scripts { 'client/main.lua', 'client/bridge.lua', 'client/modules/*.lua' }